...
def Convnet(input_shape = (400,1,2),classes = 1):

    X_input = Input(input_shape)
 
    # Stage 3
    X = Conv2D(64,kernel_size=(1,1),strides=(1,1),name="conv1",kernel_initializer=glorot_uniform(seed=0))(X_input)
...
train_x=np.reshape(train_x,(train_x.shape[0],400,1,2))
test_x=np.reshape(test_x,(test_x.shape[0],400,1,2))
